        ...
        <Row align="middle" justify="center" style={{minHeight: "70vh"}}>
            <Col>
                <Card size="default" title="Register" style={{ minWidth: "300px", maxWidth: "500px"}}>
                    ...
                    {error.email !== undefined && <Text style={{marginBottom: "8px", display:"inline-block"}} type="danger" className="errorForm">{error.email}</Text>}
                    <Input onChange={changeUsername} size="large" type="text" placeholder="Username..." style={{marginBottom: "8px"}}></Input>
                    {error.username !== undefined && <Text style={{marginBottom: "8px", display:"inline-block"}} type="danger" className="errorForm">{error.username}</Text>}
                    <Input onChange={changePassword} size="large" type="text" placeholder="Password..." style={{marginBottom: "8px"}}></Input>
                    {error.password !== undefined && <Text style={{marginBottom: "8px", display:"inline-block"}} type="danger" className="errorForm">{error.password}</Text>}
